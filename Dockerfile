...
COPY ./config/aliases /root/.zshrc.d/
COPY ./config/nvim /root/.config/nvim
COPY ./config/tmux.conf /root/.tmux.conf
COPY ./config/tmux/plugins/ /root/.tmux/
...
RUN /home/linuxbrew/.linuxbrew/bin/brew install fzf
RUN /home/linuxbrew/.linuxbrew/bin/brew install awscli
RUN /home/linuxbrew/.linuxbrew/bin/brew install kubectl
RUN /home/linuxbrew/.linuxbrew/bin/brew install krew
RUN /home/linuxbrew/.linuxbrew/bin/brew install gitleaks
RUN /home/linuxbrew/.linuxbrew/bin/brew install trufflehog
RUN /home/linuxbrew/.linuxbrew/bin/brew install checkov
RUN /home/linuxbrew/.linuxbrew/bin/brew install prowler
RUN /home/linuxbrew/.linuxbrew/bin/brew install cloudsplaining
RUN /home/linuxbrew/.linuxbrew/bin/brew install azure-cli
RUN /home/linuxbrew/.linuxbrew/bin/brew install scoutsuite
RUN /home/linuxbrew/.linuxbrew/bin/brew install trivy
RUN /home/linuxbrew/.linuxbrew/bin/brew install grype
RUN /home/linuxbrew/.linuxbrew/bin/brew install nuclei
RUN /home/linuxbrew/.linuxbrew/bin/brew install cloudfox
RUN /home/linuxbrew/.linuxbrew/bin/brew install git
RUN /home/linuxbrew/.linuxbrew/bin/brew install neovim
RUN /home/linuxbrew/.linuxbrew/bin/brew install golang
RUN /home/linuxbrew/.linuxbrew/bin/brew install jq
RUN /home/linuxbrew/.linuxbrew/bin/brew install xq
RUN /home/linuxbrew/.linuxbrew/bin/brew install curl
RUN /home/linuxbrew/.linuxbrew/bin/brew unlink util-linux
RUN /home/linuxbrew/.linuxbrew/bin/brew install wget2
RUN /home/linuxbrew/.linuxbrew/bin/brew install unzip
RUN /home/linuxbrew/.linuxbrew/bin/brew install noseyparker
RUN /home/linuxbrew/.linuxbrew/bin/brew install zsh-completion
RUN /home/linuxbrew/.linuxbrew/bin/brew install zizmor
RUN /home/linuxbrew/.linuxbrew/bin/brew install node
RUN /home/linuxbrew/.linuxbrew/bin/brew install azqr
RUN /home/linuxbrew/.linuxbrew/bin/brew install testssl
RUN /home/linuxbrew/.linuxbrew/bin/brew install tmux
RUN /home/linuxbrew/.linuxbrew/bin/brew install ripgrep
...
RUN /opt/john/src/configure && \
    make -s clean && \
    make -sj4 && \
    echo "alias john=\"/opt/john/run/john\"" > /root/.zshrc.d/john.rc
...
RUN git clone https://github.com/garrettfoster13/sccmhunter /opt/sccmhunter && \
    ...
    echo "alias sccmhunter=\"/opt/sccmhunter/venv/bin/python /opt/sccmhunter/sccmhunter.py\"" > /root/.zshrc.d/sccmhunter.rc
...
RUN git clone https://github.com/ImpostorKeanu/eavesarp /opt/eavesarp && \
    ...
    echo "alias eavesarp=\"/opt/eavesarp/venv/bin/python /opt/eavesarp/eavesarp.py\"" > /root/.zshrc.d/eavesarp.rc
...
RUN git clone https://github.com/rbsec/dnscan /opt/dnscan && \
    ...
    echo "alias dnsscan=\"/opt/dnscan/venv/bin/python /opt/dnscan/dnscan.py\"" > /root/.zshrc.d/dnsscan.rc
...
RUN git clone https://github.com/ShutdownRepo/targetedKerberoast /opt/targetedKerberoast && \
    ...
    echo "alias targetedKerberoast=\"/opt/targetedKerberoast/venv/bin/python /opt/targetedKerberoast/targetedKerberoast.py\"" > /root/.zshrc.d/targetedKerberoast.rc
...
RUN git clone https://github.com/fox-it/cve-2019-1040-scanner /opt/cve-2019-1040-scanner && \
    echo "alias cve-2019-1040-scanner=\"python3 /opt/cve-2019-1040-scanner/scan.py\"" > /root/.zshrc.d/cve-2019-1040-scanner.rc
...
RUN git clone https://github.com/dirkjanm/privexchange /opt/privexchange && \
    ...
    echo "alias privexchange=\"/opt/privexchange/venv/bin/python /opt/privexchange/privexchange.py\"" > /root/.zshrc.d/privexchange.rc
...
RUN git clone https://github.com/lgandx/PCredz /opt/PCredz && \
    ...
    echo "alias Pcredz=\"/opt/PCredz/venv/bin/python /opt/PCredz/Pcredz\"" > /root/.zshrc.d/Pcredz.rc
...
RUN git clone https://github.com/dirkjanm/krbrelayx /opt/krbrelayx && \
    ...
    echo "alias krbrelayx=\"/opt/krbrelayx/venv/bin/python /opt/krbrelayx/krbrelayx.py\"" > /root/.zshrc.d/krbrelayx.rc
...
RUN git clone https://github.com/zyn3rgy/LdapRelayScan /opt/LdapRelayScan && \
    ...
    echo "alias LdapRelayScan=\"/opt/LdapRelayScan/venv/bin/python /opt/LdapRelayScan/LdapRelayScan.py\"" > /root/.zshrc.d/LdapRelayScan.rc

# passthecert
RUN git clone https://github.com/AlmondOffSec/PassTheCert /opt/PassTheCert && \
    echo "alias passthecert=\"python3 /opt/PassTheCert/Python/passthecert.py\"" > /root/.zshrc.d/PassTheCert.rc
...
RUN git clone https://github.com/internetwache/GitTools /opt/GitTools && \
    ...
    echo "alias gitfinder=\"python3 /opt/GitTools/Finder/gitfinder.py\"" > /root/.zshrc.d/gitfinder.rc
...
RUN git clone https://github.com/dirkjanm/PKINITtools /opt/PKINITtools && \
    ...
    echo "alias gettgtpkinit=\"python3 /opt/PKINITtools/gettgtpkinit.py\"" > /root/.zshrc.d/gettgtpkinit.rc && \
    echo "alias getnthash=\"python3 /opt/PKINITtools/getnthash.py\"" > /root/.zshrc.d/getnthash.rc && \
    echo "alias gets4uticket=\"python3 /opt/PKINITtools/gets4uticket.py\"" > /root/.zshrc.d/gets4uticket.rc
...
RUN git clone https://github.com/eldraco/Sapito /opt/Sapito && \
    ...
    echo "alias sapito=\"python3 /opt/Sapito/sapito.py\"" > /root/.zshrc.d/sapito.rc
...
RUN git clone https://github.com/joaomatosf/jexboss /opt/jexboss && \
    ...
    echo "alias jexboss=\"python3 /opt/jexboss/jexboss.py\"" > /root/.zshrc.d/jexboss.rc

# o365enum
RUN git clone https://github.com/gremwell/o365enum /opt/o365enum && \
    echo "alias o365enum=\"python3 /opt/o365enum/o365enum.py\"" > /root/.zshrc.d/o365enum.rc
...
RUN git clone https://github.com/mzfr/rsh /opt/rsh && \
    ...
    echo "alias rsh=\"python3 /opt/rsh/rsh\"" > /root/.zshrc.d/rsh.rc
...
RUN git clone https://github.com/ticarpi/jwt_tool /opt/jwt_tool && \
    ...
    echo "alias jwt_tool=\"python3 /opt/jwt_tool/jwt_tool.py\"" > /root/.zshrc.d/jwt_tool.rc
...
RUN git clone https://github.com/l4rm4nd/LinkedInDumper /opt/linkedin-dumper && \
    ...
    echo "alias linkedin-dumper=\"python3 /opt/linkedin-dumper/linkedin-dumper.py\"" > /root/.zshrc.d/linkedin-dumper.rc
...
RUN git clone https://github.com/NotSoSecure/NoPrompt /opt/NoPrompt && \
    ...
    echo "alias noprompt=\"python3 /opt/NoPrompt/noprompt.py\"" > /root/.zshrc.d/NoPrompt.rc
...
RUN git clone "https://github.com/mosesrenegade/PMapper" /opt/PMapper && \
	/home/linuxbrew/.linuxbrew/bin/python3 -m venv /opt/PMapper/venv && \
...
# pacu
RUN /home/linuxbrew/.linuxbrew/bin/python3 -m venv /opt/pacu/venv && \
	/opt/pacu/venv/bin/pip install pacu && \
...
RUN git clone "https://github.com/0x5ubt13/kubenumerate" /opt/kubenumerate && \
    ...
    echo "alias kubenumerate=\"/opt/kubenumerate/venv/bin/python /opt/kubenumerate/kubenumerate.py\"" > /root/.zshrc.d/kubenumerate.rc
...
RUN git clone "https://github.com/cyberark/KubiScan" /opt/KubiScan && \
    ...
    echo "alias KubiScan=\"/opt/KubiScan/venv/bin/python /opt/KubiScan/KubiScan.py\"" > /root/.zshrc.d/KubiScan.rc
...
RUN git clone "https://github.com/hac01/iam-policy-visualize" /opt/iam-policy-visualize && \
    ...
    echo "alias iam-policy-visualize=\"/opt/iam-policy-visualize/venv/bin/python /opt/iam-policy-visualize/main.py\"" > /root/.zshrc.d/iam-policy-visualize.rc
...
RUN git clone "https://github.com/hac01/gcp-iam-brute" /opt/gcp-iam-brute && \
    ...
    echo "alias gcp-iam-brute=\"/opt/gcp-iam-brute/venv/bin/python /opt/gcp-iam-brute/main.py\"" > /root/.zshrc.d/gcp-iam-brute.rc
...
RUN git clone "https://github.com/egre55/gcp-permissions-checker" /opt/gcp-permissions-checker && \
    ...
    echo "alias gcp-permissions-checker=\"/opt/gcp-permissions-checker/venv/bin/python /opt/gcp-permissions-checker/main.py\"" > /root/.zshrc.d/gcp-permissions-checker.rc
...
RUN git clone "https://github.com/Friends-Security/sharefiltrator" /opt/sharefiltrator && \
    ...
    echo "alias sharefiltrator=\"/opt/sharefiltrator/venv/bin/python /opt/sharefiltrator/sharefiltrator.py\"" > /root/.zshrc.d/sharefiltrator.rc
...
RUN git clone "https://github.com/securesloth/noCAP" /opt/noCAP && \
    ...
    echo "alias noCAP=\"/opt/noCAP/venv/bin/python /opt/noCAP/noCAP.py\"" > /root/.zshrc.d/noCAP.rc
...
RUN git clone "https://gitlab.com/snotra.cloud/aws.git" /opt/snotra_aws && \
    ...
    echo "alias snotra_aws=\"/opt/snotra_aws/venv/bin/python /opt/snotra_aws/snorta.py\"" > /root/.zshrc.d/snotra.rc
...
RUN git clone "https://gitlab.com/snotra.cloud/azure.git" /opt/snotra_azure && \
    ...
    echo "alias snotra_azure=\"/opt/snotra_azure/venv/bin/python /opt/snotra_azure/snorta.py\"" >> /root/.zshrc.d/snotra.rc
...
RUN git clone "https://gitlab.com/snotra.cloud/kubernetes.git" /opt/snotra_kubernetes && \
    ...
    echo "alias snotra_kubernetes=\"/opt/snotra_kubernetes/venv/bin/python /opt/snotra_kubernetes/snorta.py\"" >> /root/.zshrc.d/snotra.rc
...
# cuda
WORKDIR /opt/
RUN wget -q https://developer.download.nvidia.com/compute/cuda/13.0.0/local_installers/cuda-repo-debian12-13-0-local_13.0.0-580.65.06-1_amd64.deb && \
    dpkg -i /opt/cuda-repo-debian12-13-0-local_13.0.0-580.65.06-1_amd64.deb && \
